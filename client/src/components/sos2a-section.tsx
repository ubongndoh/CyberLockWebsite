  ...
  return (
    <section id="sos2a" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* SOS2A Demo Application */}
        <div className="bg-neutral-50 rounded-xl shadow-lg p-6 md:p-8">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/3">
              <h3 className="text-xl font-semibold font-heading mb-4 text-primary">SOS2A Assessment Tool</h3>
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <div className="mt-6">
                    <Link 
                      href="/sos2a-tool" 
                      className="w-full bg-primary hover:bg-blue-700 text-white py-2 px-4 rounded transition duration-150 ease-in-out block text-center"
                    >
                      Start Assessment
                    </Link>
                  </div>
            ...
            <div className="md:w-2/3">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h4 className="text-lg font-semibold mb-4 text-primary">What You'll Receive</h4>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h5 className="font-medium text-primary">Preliminary Report</h5>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h5 className="font-medium text-primary">Mitigation Strategies</h5>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h5 className="font-medium text-primary">Compliance Guidance</h5>
